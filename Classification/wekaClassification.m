...
classTrain = cellstr(num2str(classTrain));
classTest = cellstr(num2str(classTest));
...
%%Update directory
javaaddpath('C:\Users\...\weka.jar');
javaaddpath('C:\Users\...\matlab2weka.jar');
...
elseif(classifier == 5)
    ...
    %trainModel.setAutoBuild(true);
    %trainModel.setDecay(false);
    trainModel.setLearningRate(0.3);
    trainModel.setMomentum(0.2);
    trainModel.setTrainingTime(500);
    trainModel.setValidationSetSize(0);
    trainModel.setSeed(0);
    trainModel.setValidationThreshold(20);
    trainModel.setHiddenLayers('a');
    trainModel.buildClassifier(ft_train_weka);
end
